class OrderDestination
  ...
  attr_accessor :zip, :shipping_area_id, :city, :block, :building, :phone_number, :user_id, :item_id, :token
  ...
  validates :phone_number,
            format: { with: /\A\d{10,11}\z/, message: 'is invalid. Input half-width numeric characters(10 or 11 digits).' }
